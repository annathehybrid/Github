...
public class Beverages_Adapter extends RecyclerTabLayout.Adapter<Beverages_Adapter.ViewHolder>{

    private Beverages_Pager_Adapter mAdapater;

    public Beverages_Adapter(ViewPager viewPager) {
        super(viewPager);
        mAdapater = (Beverages_Pager_Adapter) mViewPager.getAdapter();
    }

    @Override
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.tab_beverages, parent, false);
