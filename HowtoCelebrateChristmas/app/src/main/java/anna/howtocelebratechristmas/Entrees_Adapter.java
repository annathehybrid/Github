...
public class Entrees_Adapter extends RecyclerTabLayout.Adapter<Entrees_Adapter.ViewHolder> {

    private Entrees_Pager_Adapter mAdapater;

    public Entrees_Adapter(ViewPager viewPager) {
        super(viewPager);
        mAdapater = (Entrees_Pager_Adapter) mViewPager.getAdapter();
    }

    @Override
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.tab_entrees, parent, false);
