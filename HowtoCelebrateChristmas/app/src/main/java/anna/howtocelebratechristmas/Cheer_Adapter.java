...
public class Cheer_Adapter extends RecyclerTabLayout.Adapter<Cheer_Adapter.ViewHolder>{

    private Cheer_Pager_Adapter mAdapater;

    public Cheer_Adapter(ViewPager viewPager) {
        super(viewPager);
        mAdapater = (Cheer_Pager_Adapter) mViewPager.getAdapter();
    }

    @Override
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.tab_cheer, parent, false);
